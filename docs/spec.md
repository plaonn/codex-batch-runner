...
- [Closed-loop orchestration](orchestration.md): D1 deterministic read-only surface recommendation, D2 explicit idempotent CBR admission, D3-0 guarded reconciliation shadow, and the default-disabled D3-1 Todoist approval-signal pilot.
