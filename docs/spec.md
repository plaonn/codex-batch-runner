...
- [Closed-loop orchestration](orchestration.md): D1 deterministic read-only surface recommendation and D2 explicit idempotent CBR admission with runtime-private execution binding.
