...
이 문서는 execution profile, shell backend, capacity/priority, queue admission, Codex command wrapper, watchdog, lock, atomic write, rate-limit, queue mutation control plane을 정의합니다. 핵심 스펙 index는 [spec.md](spec.md)입니다.
