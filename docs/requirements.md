...
- Revisit signal status: D1 planner, D2 explicit CBR dispatch, D3-0 generic reconciliation shadow, and D3-1 CBR-owned local ingress plus durable shadow state implemented; guarded invocation, consumer retry leases, durable repair, disposition delivery, and coordination mutation remain unauthorized.
