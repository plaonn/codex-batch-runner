...
- Revisit signal status: not observed
- Evidence: [docs/model-routing-contract.md](model-routing-contract.md), [docs/execution.md](execution.md), [docs/task-schema.md](task-schema.md)
