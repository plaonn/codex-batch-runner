...
class CliTests(unittest.TestCase):
    ...
    def test_list_distinguishes_pending_reviewer_results(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("\033[100;91mreview_needs_fix\033[0m", color_output)
            self.assertIn("\033[100;92mreview_pass_pending\033[0m", color_output)
    ...
    def test_list_demo_renders_without_reading_queue_or_state(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("\033[103;30;1m??\033[0m\033[100;93mawaiting_review\033[0m", color_output)
            self.assertIn("\033[106;30;1m>>\033[0m\033[100;96mrunning\033[0m", color_output)
            self.assertIn("\033[103;30;1m||\033[0m\033[100;93mblocked_dependency\033[0m", color_output)
            ...
            self.assertIn("\033[100;93maccepted_unapplied\033[0m", color_output)
    ...
    def test_list_color_modes_respect_auto_no_color_and_json(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("\033[106;30;1m..\033[0m\033[100;96mrunnable\033[0m", always_output)
            self.assertIn("\033[103;30;1m??\033[0m\033[100;93mawaiting_review\033[0m", always_output)
            self.assertIn("\033[102;30;1m==\033[0m\033[100;92mcompleted\033[0m", always_output)
            self.assertIn("\033[101;97;1m!!\033[0m\033[100;91mfailed\033[0m", always_output)
            self.assertIn("\033[100;96mrunnable\033[0m", always_output)
            self.assertIn("\033[100;94mneeds_resume\033[0m", always_output)
            self.assertIn("\033[100;93mawaiting_review\033[0m", always_output)
