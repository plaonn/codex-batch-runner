...
class CliTests(unittest.TestCase):
    ...
    def test_list_demo_renders_without_reading_queue_or_state(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("\033[100m\033[1m\033[97m??\033[0m\033[103;30mawaiting_review\033[0m", color_output)
            self.assertIn("\033[100m\033[1m\033[97m>>\033[0m\033[106;30mrunning\033[0m", color_output)
            self.assertIn("\033[100m\033[1m\033[97m||\033[0m\033[100;93mblocked_dependency\033[0m", color_output)
    ...
    def test_list_color_modes_respect_auto_no_color_and_json(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("\033[100m\033[1m\033[97m..\033[0m\033[100;96mrunnable\033[0m", always_output)
            self.assertIn("\033[100m\033[1m\033[97m??\033[0m\033[103;30mawaiting_review\033[0m", always_output)
            self.assertIn("\033[100m\033[1m\033[97m==\033[0m\033[100;32mcompleted\033[0m", always_output)
            self.assertIn("\033[100m\033[1m\033[97m!!\033[0m\033[101;30mfailed\033[0m", always_output)
