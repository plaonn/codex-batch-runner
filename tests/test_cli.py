...
class CliTests(unittest.TestCase):
    ...
    def test_list_color_modes_respect_auto_no_color_and_json(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertIn("\033[48;5;238m\033[1m\033[96m..\033[0m\033[100;96mrunnable\033[0m", always_output)
            self.assertIn("\033[48;5;238m\033[1m\033[93m??\033[0m\033[103;30mawaiting_review\033[0m", always_output)
            self.assertIn("\033[48;5;238m\033[1m\033[32m==\033[0m\033[100;32mcompleted\033[0m", always_output)
