...
def build_reviewer_prompt(
    ...
    *,
    ...
    return (
        ...
        "When review_bundle.commit_information.ancestry.status is equal or ancestor, treat the reported task commit "
        "as present in the current HEAD history; a newer current HEAD alone is not a mismatch. Use needs_human for "
        "ancestry status not_reachable or other evidence that the reported task commit is missing.\n"
        "reviewer_task_id: "
        f"{task_id}\n"
        "review_input_json:\n"
